        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" name="mobile"  class="form-control" readonly  value="<?php echo $userdata[0]['username']; ?>">
                </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="submit" class="form-control btn btn-primary" value="Update" style="max-width: 400px; margin: 0 auto;">
                </div>
            </div>
             <div class="col-md-6">
