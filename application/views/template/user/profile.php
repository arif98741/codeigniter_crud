<div class="row" style="margin-top: 40px;">
    ...
    <div class="well spacing-top col-md-offset-1 col-md-5">
        ...
        <?php if($userdata[0]->id == $this->session->id || $this->session->designation == 'admin'): ?>

            <a href="<?php echo site_url("user/edituser")."/"; ?><?php echo $userdata[0]->id; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i>&nbsp;Edit User</a>

         <?php endif; ?>


         <a href="<?php echo site_url("user/userlist"); ?>" class="btn btn-success"><i class="fa fa-refresh"></i>&nbsp;Back</a>
